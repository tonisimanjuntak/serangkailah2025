  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Mutasi Persediaan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
              <li class="breadcrumb-item active">Daftar Mutasi Persediaan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  ...
  var akseslevel = '<?php echo $akseslevel ?>';
  ...
  $('#cetak').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/daftarmutasipersediaan_cetak/cetak/') ?>" + tglawal + "/" + tglakhir + "/" + kdruangan + "/" + kdkelompok + "/" + keybarang + "/Daftar Mutasi Persediaan");
    });
  ...
  $('#excel').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/daftarmutasipersediaan_cetak/excel/') ?>" + tglawal + "/" + tglakhir + "/" + kdruangan + "/" + kdkelompok + "/" + keybarang + "/Daftar Mutasi Persediaan");
