		...
		if ($noterima_old != $row->noterima) {
			...
			$table .= '
							<tr style="font-size: 12px;">
								...
								<td width="15%" style="text-align:right;">'.number_format($row->hargabelisatuan).'</td>		
								<td width="15%" style="text-align:right;">'.number_format($row->qtyterima*$row->hargabelisatuan).'</td>				
							</tr>
