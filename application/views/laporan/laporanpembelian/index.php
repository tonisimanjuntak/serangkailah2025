...
<script type="text/javascript">
  ...
  $('#cetak').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/laporanpembelian_cetak/cetak/') ?>" + kdruangan + "/" + tglawal + "/" + tglakhir + "/" + kdkelompok + "/" + keybarang + "/Laporan Pembelian");
    });
  ...
  $('#excel').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/laporanpembelian_cetak/excel/') ?>" + kdruangan + "/" + tglawal + "/" + tglakhir + "/" + kdkelompok + "/" + keybarang + "/Laporan Pembelian");
