  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laporan Stok FIFO Barang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
              <li class="breadcrumb-item active">Laporan Stok FIFO Barang</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  ...
  $('#cetak').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/laporanstokfifo_cetak/cetak/') ?>" + kdruangan + "/" + kdkelompok + "/" + keybarang + "/Laporan Stok Barang");
    });
  ...
  $('#excel').click(function(e){
        ...
        window.open("<?php echo site_url('laporan/laporanstokfifo_cetak/excel/') ?>" + kdruangan + "/" + kdkelompok + "/" + keybarang + "/Laporan Stok Barang");
    });
