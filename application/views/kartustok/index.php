  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Kartu Persediaan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="">Nama Barang</label>
                        <select name="keybarang" id="keybarang" class="form-control">
                        </select>
                    </div>
                  </div>
...
<script type="text/javascript">
        ...
        ajax: {
            ...
            data: function(params) {
                return {
                    ...
                    kdruangan: $('#kdruangan').val(),
                    kdkelompok: $('#kdkelompok').val(),
                };
            },
  ...
  $('#excel').click(function(e){
    ...
    function cetak(jenislaporan) {
        ...
        if (kdkelompok == '' || kdkelompok == null) {
            swal("Kelompok Barang", "Kelompok barang belum dipilih!!", "warning");
            return false;
        }

        if ( keybarang=='' || keybarang==null ) {
          swal("Nama Barang", "Nama barang belum dipilih!!", "warning");
          return false;
        };
