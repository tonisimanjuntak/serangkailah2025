...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Saldo Barang Awal Tahun <?php echo $this->session->userdata('tahunanggaran') ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
            <li class="breadcrumb-item active" id="lblactive">Saldo Awal</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card" id="cardcontent">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group row required" style="display: none;">
                        ...
                        <div class="col-md-3">
                          <input type="date" name="tglterima" id="tglterima" class="form-control" value="<?php echo( $tglsaldoawal ) ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row required">
                        ...
                        <div class="col-md-10">
                          <textarea name="uraian" id="uraian" class="form-control" rows="3" placeholder="Contoh: Pembelian ATK Kegiatan Alat Tulis Kantor">Saldo Awal Tahun <?php echo($this->session->userdata('tahunanggaran')) ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="card">
                          <div class="card-body">
                              <h3 class="text-muted text-center">Detail Saldo Awal</h3>
                              <hr>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        "select": true,
            ...
            "bInfo" : false, 
             "ajax"  : {
                      "url": "<?php echo site_url('saldoawal/datatablesourcedetail')?>",
                      "dataType": "json",
                      "type": "POST",
  ...
  //------------------------------------------------------------------------> END VALIDASI DAN SIMPAN
    ...
    $('#table tbody').on( 'click', 'span', function () {
        ...
        // $.ajax({
        //   url: '<?php echo(site_url('saldoawal/cek_pengeluaran')) ?>',
  ...
  $('#simpan').click(function(){
    ...
    if ( ! table.data().count() ) {
          ...
          $.ajax({
                url         : '<?php echo site_url("saldoawal/delete") ?>', 
                dataType    : 'json', 
                encode      : true
            })
            .done(function(result){
                if (result.success) {
                    swal("Berhasil!", "Berhasil simpan data!", "success")
                      .then( (value) => {
                          window.location.href = "<?php echo(site_url('saldoawal')) ?>";
                      });
                }else{
      ...
      $.ajax({
                type        : 'POST', 
                url         : '<?php echo site_url("saldoawal/simpan") ?>', 
                data        : formData, 
                dataType    : 'json', 
                encode      : true
            })
