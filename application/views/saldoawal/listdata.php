  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Saldo Barang Awal Tahun</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              <div class="card-header">
                <h5 class="card-title">List Data Pembelian Barang</h5>
                <a href="<?php echo(site_url('Pembelianbarang/tambah')) ?>" class="btn btn-sm btn-info float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <table class="table table-bordered table-striped table-condesed" id="table">
                        <thead>
                          <tr class="bg-info" style="">
                            ...
                            <th style="width: 15%; text-align: center;">No Terima</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('Pembelianbarang/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
