      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo(site_url('ruangan')) ?>">Ruangan</a></li>
                ...
                <div class="card" id="cardcontent">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group row required">
                        <label for="" class="col-md-2 col-form-label">Nama Ruangan</label>
                        <div class="col-md-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <textarea name="alamat" id="alamat" class="form-control" rows="2" placeholder="Alamat Ruangan"></textarea>
                        </div>
                      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    if ( kdruangan != "" ) { 
          ...
          $('#lbljudul').html('Edit Data Ruangan');
          $('#lblactive').html('Edit');

    }else{
          $('#lbljudul').html('Tambah Data Ruangan');
