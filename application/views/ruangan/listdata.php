          ...
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              <div class="card-header">
                <h5 class="card-title">List Data Sekolah</h5>
                <?php if ($this->session->userdata('akseslevel')=='9') { ?>
                  <a href="<?php echo(site_url('ruangan/tambah')) ?>" class="btn btn-sm btn-info float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                <?php } ?>
              </div>
              <div class="card-body">
                <div class="row">
                      ...
                      <table class="table table-bordered table-striped table-condesed" id="table">
                        <thead>
                          <tr class="bg-info" style="">
                            ...
                            <th style="width: 15%; text-align: center;">Kode Sekolah</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('Ruangan/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
